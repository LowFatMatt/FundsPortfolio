...
Thank you for your interest in contributing to FundsPortfolio ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it by following the instructions given in CONTRIBUTING.md. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
1. Definitions
        ...
        "Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please contact the maintainers via a GitHub issue and obtain explicit approval from the rights holder before submitting.
...
In addition, We may use the following licenses for Media in the Contribution: Creative Commons Attribution 3.0 Unported (CC BY 3.0) (including any right to adopt any future version of a license if permitted).
...
(d) You have followed the instructions above, if You do not own the Copyright in the entire work of authorship Submitted.
