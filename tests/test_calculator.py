...
class TestPortfolioCalculator:
    ...
    def test_enrich_and_rank_funds(self):
        ...
        def mock_get_metrics(isin):
            if isin == "FUND1": return {"annualized_return": 0.12, "annualized_volatility": 0.10} # Sharpe ~1.0
            if isin == "FUND2": return {"annualized_return": 0.06, "annualized_volatility": 0.05} # Sharpe ~0.8
            if isin == "FUND3": return {"annualized_return": 0.08, "annualized_volatility": 0.20} # Sharpe ~0.3
            return None
