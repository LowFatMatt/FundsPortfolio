...
def _synthetic_result():
    recommendations = [
        {
            "isin": "A", "name": "A", "allocation_percent": 30,
            "region": "north_america", "theme": "NONE", "is_etf": True,
            "esg_label": "SFDR_ARTICLE_8", "provider": "Deka",
            "asset_class": "equity", "core_satellite_class": "core",
        },
        {
            "isin": "B", "name": "B", "allocation_percent": 25,
            "region": "north_america", "theme": "NONE", "is_etf": True,
            "esg_label": None, "provider": "Amundi",
            "asset_class": "equity", "core_satellite_class": "core",
        },
        {
            "isin": "C", "name": "C", "allocation_percent": 20,
            "region": "global", "theme": "NONE", "is_etf": True,
            "esg_label": "SFDR_ARTICLE_8", "provider": "Helaba",
            "asset_class": "equity", "core_satellite_class": "core",
        },
        {
            "isin": "D", "name": "D", "allocation_percent": 15,
            "region": "global", "theme": "ai_robotics", "is_etf": False,
            "esg_label": None, "provider": "Deka",
            "asset_class": "equity", "core_satellite_class": "satellite",
        },
        {
            "isin": "E", "name": "E", "allocation_percent": 10,
            "region": "global", "theme": "ai_robotics", "is_etf": True,
            "esg_label": "SFDR_ARTICLE_8", "provider": "Deka",
            "asset_class": "mixed", "core_satellite_class": "satellite",
        },
    ]
    portfolio_metrics = {
        "risk_profile": "OPPORTUNITY", "srri_proxy": 6, "weighted_fee": 0.5,
        "etf_share": 0.85,
        "region_exposures": {"north_america": 0.55, "global": 0.45},
        "theme_exposures": {"NONE": 0.75, "ai_robotics": 0.25},
    }
    candidates = [
        {"isin": "A", "base": 83.04, "boosts": {"ETF": 20.0, "ESG": 20.0}, "final": 123.04},
        {"isin": "B", "base": 82.25, "boosts": {"ETF": 20.0, "Region": 30.0}, "final": 132.25},
        {"isin": "C", "base": 92.10, "boosts": {"ETF": 20.0, "ESG": 20.0}, "final": 132.10},
        {"isin": "X", "base": 51.66, "boosts": {"ETF": 20.0, "ESG": 20.0, "Region": 30.0}, "final": 121.66},
        {"isin": "E", "base": 44.20, "boosts": {"ETF": 20.0, "ESG": 20.0, "Theme": 30.0}, "final": 114.20},
        {"isin": "D", "base": 26.77, "boosts": {"Theme": 30.0}, "final": 56.77},
    ]
    decision_trace = {
        "relaxations": [], "used_fallback_risk": False,
...
def test_empty_portfolio_handling():
    answers = {
        ...
        "preferred_regions": ["asia"], "preferred_themes": ["water"],
    }
    result = {
        "recommendations": [],
        "portfolio_metrics": {},
