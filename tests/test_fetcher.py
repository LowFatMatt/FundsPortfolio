...
def sample_price_data():
    ...
    dates = pd.date_range(start='2020-01-01', periods=252*5, freq='B') # 5 years of business days
    
    # Create simple linear growth with some noise
    # ~10% annual return
    daily_growth_rate = 0.10 / 252 
    noise = np.random.normal(0, 0.01, len(dates)) # Daily standard deviation of 1% (~15.8% annualized vol)
